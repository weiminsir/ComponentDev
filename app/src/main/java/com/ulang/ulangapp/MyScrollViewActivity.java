...
import com.ulang.ulangapp.widget.UPMarqueeView;
    ...
    private void initView() {
        ...
        upview1.setOnItemClickListener(new UPMarqueeView.OnItemClickListener() {
            ...
            public void onItemClick(int position, View view) {
                Toast.makeText(MyScrollViewActivity.this, "你点击了第几个items" + position, Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        for (int i = 0; i < data.size(); i = i + 2) {
            ...
            moreView.findViewById(R.id.rl).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(MyScrollViewActivity.this, position + "你点击了" + data.get(position).toString(), Toast.LENGTH_SHORT).show();
                }
            });
            /**
             * 设置监听
            ...
            moreView.findViewById(R.id.rl2).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(MyScrollViewActivity.this, position + "你点击了" + data.get(position + 1).toString(), Toast.LENGTH_SHORT).show();
                }
            });
            //进行对控件赋值
